...
ifVarBody = do
    ...
    a <- declare Felt "a" 145
    b <- declare Felt "b" 79
    target <- declare Felt "target" 203
    s <- declare Felt "s" $ get a + get b
    okVal <- declare Felt "okVal" 10
    nokVal <- declare Felt "nokVal" 20
...
simpleInfBody = do
    ...
    emptyLine
    n1 <- declare Felt "n1" 4238
    n2 <- declare Felt "n2" 21987
